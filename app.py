...
try:
    ...
    with pd.ExcelWriter(excel_io, engine='openpyxl') as writer:
        ...
        media_columns = [col for col in download_df.columns if 'url' in col.lower()]
        if media_columns:
            media_df = download_df[media_columns]
    ...
    col2.download_button(
        ...
        help="Download filtered data with media URLs and metadata"
    )
